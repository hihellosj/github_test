...
<section>
    ...
    <div id="contents">
      <div id="cancel_tit">
      <form name="cancel_form" method="" id="cancel_form" action="">
        <h2>취소내역</h2>
        ...
        <ul id="movielog_ul">
          <li class="movielog_li">
            <div class="movie_info">
		     ...
		     <p class="ticket_no">예매 번호 : 2345678</p>
		      <p class="pay_date">결제 일시 : 2023.07.31 오전 12:05:13</p>
		      <p class="cancle_date">취소 일시 : 2023.07.31 오전 12:05:13</p>
		      <p class="price"><b>환불 금액 : 15000원</b></p>
              </div>
            </div>
	      </li>	                    	 
