...
function showFindPwFailureAlert() {
	alert("입력한 아이디과 전화번호를 다시 확인하세요.");
}
</script>
<style type="text/css">
#findPwMenu {
...
<div class="animated bounceInDown">
  <div class="container">
    <span class="error animated tada" id="msg"></span>
 	...
 	<form name="pwform" class="box" method = "POST" action="<%=request.getContextPath() %>/findMemberPw.do">
		...
		<input id="findPwMenu" type="button" value="비밀번호 찾기" onClick="location.href='<%=request.getContextPath()%>/view/member/findPw.jsp'">
			...
			<input type="text" name="user_id" class = "btn-id" placeholder = "아이디입력">
