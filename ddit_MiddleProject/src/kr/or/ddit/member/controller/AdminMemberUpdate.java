...
public class AdminMemberUpdate extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("회원정보 맞나여???-------------"+memVo);
				
		request.setAttribute("memberVo", memVo);
		request.getRequestDispatcher("/view/admin/adminMemberUpdate.jsp").forward(request, response);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.sendRedirect(request.getContextPath()+"/allMemberList.do");		
