...
@WebServlet("/movieListMain2.do")
public class MovieListMain2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("/boardmvc/movielist2.jsp").forward(request, response);
	}
